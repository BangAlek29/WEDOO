                ...
                <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="container-objek relative flex flex-col bg-clip-border bg-transparent text-gray-700 border border-blue-gray-100  rounded-lg">          
                        <div class=" text-gray-700 shadow-none !m-0 p-1 text-center ">
                            <img class="style-image w-full h-60" src="{{  $MC->image_url }}" alt="Image Description">
                            <h4 class="block antialiased tracking-normal text-xl font-semibold leading-snug text-blue-gray-900">{{$MC->nama }}</h4>
                            <p class="block antialiased text-sm leading-normal text-inherit font-normal !text-gray-500">{{$MC->kontak }}</p>
                            <h4 class="block antialiased text-sm leading-normal text-inherit font-normal !text-gray-500">Biaya : Rp.{{  $MC->biaya }}<span class="block antialiased tracking-normal text-base font-semibold leading-relaxed text-blue-gray-900 -translate-y-0.5 self-end opacity-70"></span></h4>
