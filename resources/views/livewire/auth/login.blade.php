    ...
    <section class="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
      ...
      <div class="hidden lg:relative lg:block lg:p-12">
        ...
        <h2 class="mt-6 text-4xl font-bold text-white sm:text-3xl md:text-4xl">
          SELAMAT DATANG DI <span class="text-rose-500">WEDOO</span>
        </h2>

        <p class="mt-4 leading-relaxed text-white">
          Biarkan kami melayani untuk anda para mempelai tercinta.
        </p>
      </div>
    </section>
        ...
        <form action="#" class="mt-8 grid grid-cols-6 gap-6">
          <div class="col-span-6">
            ...
            <input
              ...
              id="Email"
              name="email"
              class="mt-1 w-full rounded-md border border-rose-500 bg-white text-sm text-gray-700 shadow-sm"
            />
          </div>
