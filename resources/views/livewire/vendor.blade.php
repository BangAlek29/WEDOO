     ...
     <div>
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md border border-blue-gray-100">
                <img class="w-full h-auto rounded-t-xl" src="{{ $vendor->image_url }}" alt="{{ $vendor->nama }}">
                <div class="relative bg-clip-border mt-4 mx-4 rounded-xl overflow-hidden bg-transparent text-gray-700 shadow-none !m-0 p-6">
                    <h5 class="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-blue-gray-900 capitalize">{{ $vendor->nama }}</h5>
                    <p class="block antialiased font-sans text-sm leading-normal text-inherit font-normal !text-gray-500">{{ $vendor->contact }}</p>
                    <h3 class="antialiased tracking-normal font-sans text-3xl font-semibold leading-snug text-blue-gray-900 flex gap-1 mt-4">Harga : Rp. {{ number_format($vendor->price, 2, ',', '.') }}<span class="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-blue-gray-900 -translate-y-0.5 self-end opacity-70"></span></h3>
                </div>
                <div class="p-6 border-t border-blue-gray-50">
                    <ul class="flex flex-col gap-3">
                        ...
                        <li class="flex items-center gap-3 text-gray-700">
                            <p class="block antialiased font-sans text-sm leading-normal font-normal text-inherit">{{ $vendor->description }}</p>
                        </li>
                    </ul>
