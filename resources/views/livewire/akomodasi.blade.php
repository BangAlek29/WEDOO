<!-- resources/views/livewire/akomodasis.blade.php -->
                ...
                @foreach ($akomodasis as $akomodasi)
                    <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md border border-blue-gray-100">
                        ...
                        <div class="p-6 border-t border-blue-gray-50">
                            ...
                            <button class="align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-2 px-4 rounded-lg border border-green-500 text-green-500 hover:opacity-75 focus:ring focus:ring-green-200 active:opacity-[0.85] block w-full mt-6" type="button" wire:click="saveAkomodasi('{{ $akomodasi->id_akomodasi }}')">Buy Now</button>
                        </div>
                    </div>
                @endforeach
            </div>
